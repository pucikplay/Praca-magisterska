...
#     fig.set_dpi(600)
#     if lims is not None:
#         fig.savefig(f'../../charts/mult_lat_2d_num/position_{point}_{nodes}_close.png')
#     else:
#         fig.savefig(f'../../charts/mult_lat_2d_num/position_{point}_{nodes}.png')
#     plt.close()
...
def plot_multiple(df_dict, lims, nodes, mean=False):
    ...
    if mean:
        ...
        fig.savefig(f'../../charts/mult_lat_2d_num/positions_{nodes}.png')
    plt.close()
...
if __name__ == '__main__':
    nodes_num = [str(i) for i in range(3,9)]
