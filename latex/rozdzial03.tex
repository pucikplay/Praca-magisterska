...
\begin{figure}[h]
\centering
    \includegraphics[scale=0.6]{pics/position_0.png}
...
\begin{figure}[h]
\centering
    \includegraphics[scale=0.6]{pics/position_1.png}
\caption{Wykres obliczonej pozycji odbiornika w zależności od czasu}
...
\begin{figure}[h]
\centering
    \includegraphics[scale=0.6]{pics/position_2.png}
\caption{Wykres obliczonej pozycji odbiornika w zależności od czasu}
...
% \begin{figure}[h]
% \centering
%     \includegraphics[scale=0.6]{pics/position_3.png}
% \caption{Wykres obliczonej pozycji odbiornika w zależności od czasu}
% \label{fig:position_2}
% \end{figure}
